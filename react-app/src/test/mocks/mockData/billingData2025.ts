  ...
  billing_months: [
    {
      ...
      main: {
        ...
        energy_export_meter_channel_2: {
          ...
          off_peak: { subcomponent_values: [-920.0], value: -920.0, unit: 'kWh' },
          total: { subcomponent_values: [-1045.0], value: -1045.0, unit: 'kWh' },
        },
    ...
    },
    {
      ...
      main: {
        ...
        energy_export_meter_channel_2: {
          peak: { subcomponent_values: [-145.0], value: -145.0, unit: 'kWh' },
          off_peak: { subcomponent_values: [-970.0], value: -970.0, unit: 'kWh' },
          total: { subcomponent_values: [-1115.0], value: -1115.0, unit: 'kWh' },
        },
        energy_import_meter_channel_1: {
          peak: { subcomponent_values: [83.0], value: 83.0, unit: 'kWh' },
          off_peak: { subcomponent_values: [275.0], value: 275.0, unit: 'kWh' },
          total: { subcomponent_values: [358.0], value: 358.0, unit: 'kWh' },
        },
        total_bill_in_mail: {
    ...
    },
    {
      ...
      main: {
        ...
        energy_export_meter_channel_2: {
          peak: { subcomponent_values: [-165.0], value: -165.0, unit: 'kWh' },
          off_peak: { subcomponent_values: [-1020.0], value: -1020.0, unit: 'kWh' },
          total: { subcomponent_values: [-1185.0], value: -1185.0, unit: 'kWh' },
        },
        energy_import_meter_channel_1: {
          peak: { subcomponent_values: [72.0], value: 72.0, unit: 'kWh' },
          off_peak: { subcomponent_values: [255.0], value: 255.0, unit: 'kWh' },
          total: { subcomponent_values: [327.0], value: 327.0, unit: 'kWh' },
        },
        total_bill_in_mail: {
