...
import App from './App';
import { multipleYearsHandler, emptyYearsHandler, metadataHandler, tariffScheduleHandler } from './test/mocks/handlers';
...
export const MultipleYears: Story = {
  parameters: {
    msw: {
      handlers: [multipleYearsHandler, metadataHandler, tariffScheduleHandler],
    },
  },
...
export const EmptyYears: Story = {
  parameters: {
    msw: {
      handlers: [emptyYearsHandler, metadataHandler, tariffScheduleHandler],
    },
  },
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
